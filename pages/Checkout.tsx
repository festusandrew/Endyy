  ...
  const handleCheckout = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const newOrder: Order = {
        ...
        shippingAddress: deliveryMethod === DeliveryMethod.DELIVERY ? {
            ...
            <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
              ...
              {!user && (
                <p className="text-sm text-gray-500 mb-4">
                  Checking out as a guest. <button type="button" onClick={() => navigate('/')} className="text-brand-600 font-bold hover:underline">Log in</button> for faster checkout.
                </p>
              )}
              <div>
